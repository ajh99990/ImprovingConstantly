<template>
  <div class="calculator bg-red-100 border-red-300 border-width-1px rounded-4px p-6px">
    <div class="p-4px bg-red-500 text-white">我是计算器组件，用来演示架构的核心能力——UI复用</div>
...
import { ProcessManager } from "~~/composables/useProcessScheduler/scheduler";

const pm: ComputedRef<ProcessManager> = useProcessScheduler().processManager
